<template>
  <div
    class="tm-slice tm-button-group tm-button-group-large"
  ...
  >
    ...
    >
      <div
        v-if="slice.items"
        class="tm-button-group-buttons uk-grid uk-grid-small"
      ...
      >
        <div v-for="(item, index) in slice.items" class="" :key="index">
          <DocumentLink
            ...
            class="uk-button uk-button-large tm-button-group-button"
          >
            {{ item.buttonLabel }}
          </DocumentLink>
        </div>
